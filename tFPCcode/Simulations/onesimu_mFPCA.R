...
onesimu <- function(seed,n,ni1,ni2,k1,k2,HJ1,HJ2,var_noise,casetype){
  ...
  penaltyPar = simplex(5,J,z,rawbasis,ni,Q2,Ene)
  
  
  #penaltyPar = list(c(5.0,5.0))
  ...
  results = c(sigma2, EM$D[1,1], EM$D[2,2], TMISE_mean, TMIAE_mean, angle_rho, MSE_v, MSE_Q, TMISE_indiv, TMIAE_indiv,angle_rho_mFPCA,EM$iter,lambmu,lambpc,seed)
  
  
  str2 = paste("./results_mFPCA/",casetype,"T",n,"ni", ni1,ni2, "K",k1,k2,"HJ",HJ1,HJ2,"noise",var_noise,"ParamEstDetail.txt",sep="")
...
#res = summary(results)
str1 = paste("./results_mFPCA/",casetype,"T",n,"ni", ni1,ni2, "K",k1,k2,"HJ",HJ1,HJ2,"noise",var_noise,"Summary.txt",sep="")
